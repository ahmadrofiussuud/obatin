...
export default function ApiPortalPage() {
  ...
  // Code snippets data
  const snippets = {
    curl: `curl -X POST https://api.medilink.id/v1/diagnosis/analyze \\
  ...
  -d '{
    ...
    js: `const response = await fetch('https://api.medilink.id/v1/diagnosis/analyze', {
  method: 'POST',
  headers: {
...
url = "https://api.medilink.id/v1/diagnosis/analyze"
headers = {
    "Authorization": "Bearer ma_live_90421893ea721c890f92",
    "Content-Type": "application/json"
}
  ...
  return (
    <AppShell>
      <PageHeader
        ...
        description="Gunakan endpoint terstandarisasi untuk mengintegrasikan rekam medis faskes pihak ketiga dengan MediLink, dan kelola otorisasi credentials API Key."
        breadcrumbs={[
